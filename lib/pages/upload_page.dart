  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Padding(
              ...
              child: Container(
                ...
                padding: EdgeInsets.only(
                  top: Dimensions.topPadding18,
                  right: Dimensions.leftPadding13,
                  left: Dimensions.leftPadding13,
                ),
      ...
      floatingActionButton: Padding(
        padding: EdgeInsets.only(
          left: Dimensions.leftPadding35,
          right: Dimensions.rightPadding15,
          bottom: Dimensions.bottomPadding8,
        ),
        child: Container(
